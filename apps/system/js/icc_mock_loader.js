...
var icc_mock_loader = {
  load: function(callback) {
    ...
    reqIccFake.onsuccess = function iccFaked() {
      ...
      if (!((navigator.mozMobileConnection && navigator.mozMobileConnection.icc)
        ...
        DUMP('STK alternative loader: Using real ICC obj.: Registering icc-stkcommand System Message');
        callback(null);
      }
    };
